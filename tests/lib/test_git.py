...
class TestGitLibrary:
    ...
    def test_create_working_repository(self, mocker):
        mocker.patch.object(config, "for_app", return_value={})
        mocker.patch.object(
            git,
        ...
        io.get_temporary_copy.assert_called_once_with("/fixtures-nestor-pristine/my-app", "my-app")
    ...
    def test_tag(self, mocker):
        ...
        config.for_app.assert_called_once_with("my-app")
